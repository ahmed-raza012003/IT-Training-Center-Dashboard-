                        ...
                        <div class="mb-3">
                            ...
                            <select id="batch_id" name="batch_id" class="form-select @error('batch_id') is-invalid @enderror">
                                ...
                                @foreach ($batches as $batch)
                                    <option value="{{ $batch->id }}" {{ old('batch_id') == $batch->id ? 'selected' : '' }}>{{ $batch->batch_number }}</option>
                                @endforeach
                            </select>
                            @error('batch_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="timing_id" name="timing_id" class="form-select @error('timing_id') is-invalid @enderror">
                                ...
                                @foreach ($timings as $timing)
                                    <option value="{{ $timing->id }}" {{ old('timing_id') == $timing->id ? 'selected' : '' }}>{{ $timing->time_slot }}</option>
                                @endforeach
                            </select>
                            @error('timing_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="fee_structure_id" name="fee_structure_id" class="form-select @error('fee_structure_id') is-invalid @enderror">
                                ...
                                @foreach ($fees as $feeStructure)
                                    <option value="{{ $feeStructure->id }}" {{ old('fee_structure_id') == $feeStructure->id ? 'selected' : '' }}>{{ $feeStructure->final_fee }}</option>
                                @endforeach
                            </select>
