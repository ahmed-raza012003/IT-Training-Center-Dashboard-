                    ...
                    <div class="container">
                        ...
                        <form action="{{ route('courses.update', $course) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="instructor" name="instructor" class="form-select" required>
                                    @foreach ($instructors as $instructor)
                                        <option value="{{ $instructor->name }}" {{ $instructor->name == $course->instructor ? 'selected' : '' }}>
                                            {{ $instructor->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="lectures" name="lectures" value="{{ old('lectures', $course->lectures) }}" >
                                @error('lectures')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="quizzes" name="quizzes" value="{{ old('quizzes', $course->quizzes) }}" >
                                @error('quizzes')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="skill_level" name="skill_level" value="{{ old('skill_level', $course->skill_level) }}" >
                                @error('skill_level')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="certificate" name="certificate" class="form-select">
                                    <option value="0" {{ old('certificate', $course->certificate) == 0 ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ old('certificate', $course->certificate) == 1 ? 'selected' : '' }}>Yes</option>
                                </select>
                                @error('certificate')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
