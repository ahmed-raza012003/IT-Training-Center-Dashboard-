                    ...
                    <div class="container">
                        ...
                        <form action="{{ route('fees.update', $feeStructure) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="main_fee" name="main_fee" value="{{ $feeStructure->main_fee }}" >
                            </div>
                            <div class="mb-3">
                                <label for="discount_fee" class="form-label">Discount Fee</label>
                                <input type="number" class="form-control" id="discount_fee" name="discount_fee" value="{{ $feeStructure->discount_fee }}" >
                            </div>
                            <div class="mb-3">
                                <label for="final_fee" class="form-label">Final Fee</label>
                                <input type="number" class="form-control" id="final_fee" name="final_fee" value="{{ $feeStructure->final_fee }}" >
                            </div>
