                        ...
                        <div data-simplebar class="h-100 p-4">
                            <div class="position-relative ms-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <p class="d-flex align-items-center mb-0">
                                                ...
                                                as <span class="badge bg-success-subtle text-success px-2 py-1 ms-1">Completed</span>
                                            </p>
                                            <div class="d-flex align-items-center gap-3 mt-1 bg-light bg-opacity-50 p-2 rounded-2">
                                                <a href="#!" class="fw-medium text-dark">UI/UX Figma Design</a>
                                                <div class="ms-auto">
                                                    <a href="#!" class="fw-medium text-primary fs-18" data-bs-toggle="tooltip" data-bs-title="Download" data-bs-placement="bottom">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="mb-1 text-dark fw-semibold fs-15">
                                                Larkon Application UI v2.0.0 <span class="badge bg-primary-subtle text-primary px-2 py-1 ms-1">Latest</span>
                                            </h5>
                                ...
                                <div class="position-relative ps-4">
                                    <div class="mb-4">
                                        <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20">
                                            <img src="assets/images/users/avatar-7.jpg" alt="avatar-5" class="avatar-sm rounded-circle">
                                        </span>
                                        <div class="ms-2">
                                ...
                                <div class="position-relative ps-4">
                                    <div class="mb-4">
                                        <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20">
                                            <img src="assets/images/users/avatar-6.jpg" alt="avatar-5" class="avatar-sm rounded-circle">
                                        </span>
                                        <div class="ms-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <p class="d-flex align-items-center gap-1 mt-1">
                                                Earned a <iconify-icon icon="iconamoon:certificate-badge-duotone" class="text-danger fs-20"></iconify-icon>
                                                " Best Product Award"
                                            </p>
                            ...
                            <div class="p-3 settings-bar">
                                ...
                                <div>
                                    ...
                                    <div class="form-check mb-2">
                                        ...
                                        <label class="form-check-label" for="leftbar-color-light">Light
                                             </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="data-menu-color" id="leftbar-color-dark" value="dark">
                                        <label class="form-check-label" for="leftbar-color-dark">Dark
                                             </label>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="form-check mb-2">
                                        ...
                                        <label class="form-check-label" for="leftbar-size-default">Default
                                             </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="data-menu-size" id="leftbar-size-small" value="condensed">
                                        <label class="form-check-label" for="leftbar-size-small">Condensed
                                             </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="data-menu-size" id="leftbar-hidden" value="hidden">
                                        <label class="form-check-label" for="leftbar-hidden">Hidden
                                             </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="data-menu-size" id="leftbar-size-small-hover-active" value="sm-hover-active">
                                        <label class="form-check-label" for="leftbar-size-small-hover-active">Small Hover Active
                                             </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="data-menu-size" id="leftbar-size-small-hover" value="sm-hover">
                                        <label class="form-check-label" for="leftbar-size-small-hover">Small Hover
                                             </label>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <label for="shipping-1" class="w-100 mb-2">
                                                                <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-dark fw-medium">DHL Fast Services
                                                                                          </h5>
                                                            ...
                                                            <label for="shipping-2" class="w-100">
                                                                <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-dark fw-medium">FedEx Services
                                                                                          </h5>
                                                                            <p class="mb-0 text-dark">
                                                                                Delivery -
                                                                                               <span class="text-muted fw-normal">Today</span>
                                                            ...
                                                            <label for="shipping-3" class="w-100">
                                                                <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-dark fw-medium">UPS Services
                                                                                          </h5>
                                                                            <p class="mb-0 text-dark">
                                                                                Delivery -
                                                            ...
                                                            <label for="shipping-4" class="w-100">
                                                                <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-dark fw-medium">Our Courier Services
                                                                                          </h5>
                                                                            <p class="mb-0 text-dark">
                                                                                Delivery -
                                                    ...
                                                    <div class="accordion" id="accordionExample">
                                                        <div class="card">
                                                            <div class="card-header p-0" id="pay-pal">
                                                                ...
                                                                <p class="p-3 mb-0">Safe Payment Online Credit card needed. PayPal
                                                        ...
                                                        <div class="card mb-0">
                                                            <div class="card-header p-0">
                                                                ...
                                                                <p class="p-3 mb-0">Safe Money Transfer using your bank account.
                                    ...
                                    <div class="position-relative mt-3">
                                        <div class="form-button">
                                            <form class="d-flex align-items-center justify-content-center">
                                                ...
                                                <button type="button" data-toast data-toast-text="Your Promo Code Apply Successfully" data-toast-gravity="top" data-toast-position="center" data-toast-className="success" data-toast-duration="3000" class="btn btn-light ms-2 rounded-2">Apply
                                                       </button>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer bg-light-subtle">
                                    ...
                                    <div class="alert alert-warning alert-icon mt-3 mb-0" role="alert">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">Estimated Delivery by 25 April, 2024
                                                  </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-0 mb-0">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row justify-content-between">
                                                            <div class="col-lg-4 col-6">
                                                                ...
                                                                <p class="text-dark fw-medium mt-1">23 April, 2024</p>
                                                            </div>
                                                        ...
                                                        <div class="row justify-content-between mt-3 align-items-center">
                                                            ...
                                                            <div class="col-lg-4 col-6 text-end">
                                                                <span class="text-success fw-semibold">
                                                                    Completed <i class="bx bx-check-circle align-middle"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div data-bs-theme="dark">
                                            <div class="card-footer d-flex align-items-center border-0 bg-body gap-3 rounded">
                                                ...
                                                <div class="d-block">
                                                    <p class="text-white fw-semibold mb-0">Credit/Debit Card</p>
                                                ...
                                                <div class="ms-auto">
                                                    <a href="#!" class="text-primary fs-30" data-bs-toggle="tooltip" data-bs-title="Download Invoice" data-bs-placement="bottom">
                                                        <iconify-icon icon="solar:download-square-bold" class="align-middle"></iconify-icon>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
