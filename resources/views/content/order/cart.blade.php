                        ...
                        <div class="position-relative ms-2">
                                        ...
                                        <div
                                            ...
                                            <div class="ms-auto">
                                                <a href="#!" class="fw-medium text-primary fs-18"
                                                    ...
                                                    <iconify-icon
                                                        icon="iconamoon:cloud-download-duotone"></iconify-icon>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="position-relative ps-4">
                                <div class="mb-4">
                                    <span
                                        ...
                                        <img src="assets/images/users/avatar-7.jpg" alt="avatar-5"
                            ...
                            <div class="position-relative ps-4">
                                <div class="mb-4">
                                    <span
                                        class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20">
                                        <img src="assets/images/users/avatar-6.jpg" alt="avatar-5"
                                            class="avatar-sm rounded-circle">
                                    </span>
                                    <div class="ms-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <p class="d-flex align-items-center gap-1 mt-1">
                                            Earned a <iconify-icon icon="iconamoon:certificate-badge-duotone"
                        ...
                        <div class="card cart-detail">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <div class="ms-lg-3">
                                            <a href="#!" class="fw-medium text-dark fs-18">Men Black Slim Fit
                                                T-shirt</a>
                        ...
                        <div class="card cart-detail">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <div class="ms-lg-3">
                                            <a href="#!" class="fw-medium text-dark fs-18">Dark Green Cargo
                                                Pent</a>
                                            <div class="d-flex align-items-center gap-3 mt-2">
                                                <p class="text-dark fw-medium">
                        ...
                        <div class="card cart-detail">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <div class="ms-lg-3">
                                            <a href="#!" class="fw-medium text-dark fs-18">Men Dark Brown
                                                Wallet</a>
                                            <div class="d-flex align-items-center gap-3 mt-2">
                                                <p class="text-dark fw-medium">
                        ...
                        <div class="card cart-detail">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <div class="ms-lg-3">
                                            <a href="#!" class="fw-medium text-dark fs-18">Kid's Yellow
                                                T-shirt</a>
                                            <div class="d-flex align-items-center gap-3 mt-2">
                                                <p class="text-dark fw-medium">
                        ...
                        <div class="card text-center bg-primary overflow-hidden z-1">
                                ...
                                <div class="position-relative mt-3">
                                    <div class="form-button">
                                        <form class="d-flex align-items-center justify-content-center">
                                            <input type="text"
                                                class="form-control w-50 border-0 rounded bg-light text-white bg-opacity-25"
                                                placeholder="code" required="" value="CODE123">
                                            <button type="button" data-toast
                                                ...
                                                class="btn btn-light ms-2 rounded-2">Apply
                                            </button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="position-absolute top-100 start-100 translate-middle z-n1 opacity-75">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    ...
                                    viewBox="0 0 800 800" width="400" height="400">
                                    <defs>
                                        <linearGradient x1="50%" y1="0%" x2="50%"
                                            y2="100%" id="wwwhirl-grad">
                                            <stop stop-color="hsla(0, 0%, 91%, 1.00)" stop-opacity="1"
                                                offset="45%"></stop>
                                            <stop stop-color="hsla(0, 0%, 98%, 1.00)" stop-opacity="1"
                                                offset="100%"></stop>
                                        </linearGradient>
                                    </defs>
                                    <g stroke-width="2" stroke="url(#wwwhirl-grad)" fill="none"
                                ...
                                <div class="alert alert-warning alert-icon mt-3 mb-0" role="alert">
                                    <div class="d-flex align-items-center">
                                        <div
                                            ...
                                            <iconify-icon icon="solar:kick-scooter-broken"
                                                class="align-middle text-white"></iconify-icon>
                                        </div>
